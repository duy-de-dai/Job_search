...
class CareerlinkSpider(scrapy.Spider):
    ...
    def parse_job(self, response):
        ...
        check =False
        check = response.css('#section-job-summary > div.row.job-summary.d-flex > div.col-6.pr-1.pl-3.pr-md-2 > div > div > div:nth-child(1) > div > div.my-0.summary-label::text').get().strip() == 'Mã việc làm'
        ...
        if check == False:
            ...
            job_item['employment_type'] = response.css('#section-job-summary > div.row.job-summary.d-flex > div.col-6.pr-1.pl-3.pr-md-2 > div > div > div:nth-child(2) > div > div.font-weight-bolder::text').get(default = 'not-found').strip()

            job_item['job_function'] = response.css('#section-job-summary > div.row.job-summary.d-flex > div.col-6.pr-1.pl-3.pr-md-2 > div > div > div:nth-child(3) > div > div.font-weight-bolder::text').get(default = 'not-found').strip()

            job_item['education_level'] = response.css('#section-job-summary > div.row.job-summary.d-flex > div.col-6.pr-1.pl-3.pr-md-2 > div > div > div:nth-child(4) > div > div.font-weight-bolder::text').get(default = 'not-found').strip()
